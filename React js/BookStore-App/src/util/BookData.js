export const BookData = [
    ...
    },
    {
        ...
        book_description: "Every common man who by his sheer grit and hard work achieves success should share his story with the rest for they may find inspiration and strength to go on, in his story. The 'Wings of Fire' is one such autobiography by visionary scientist Dr. APJ Abdul Kalam, who from very humble beginnings rose to be the President of India. The book is full of insights, personal moments and life experiences of Dr. Kalam. It gives us an understanding on his journey of success. Dr. Kalam by narrating his life journey evokes the reader to identify with one’s inner fire and potential, for he was of the firm belief that each one of us was born with the strength and potential to make a tangible change in the world.",
        book_url: "https://m.media-amazon.com/images/I/71KKZlVjbwL._SY466_.jpg",
        print_length: "495 pages",
        language: "English",
        author_name: "Arun Tiwari",
        price: "335",
    },
    {
        id: 10,
    ...
    {
        id: 17,
        book_name: "The Trojan War (Greenwood Guides to Historic Events of the Ancient World)",
        book_description: "In The Trojan War historian and classicist Barry Strauss explores the myth and the reality behind the war, from Homer's accounts in The Iliad and The Odyssey to Heinrich Schliemann's discovery of ancient Troy in the late nineteenth century to more recent excavations that have yielded intriguing clues to the story behind the fabled city.",
        book_url: "https://m.media-amazon.com/images/I/41E8zkkk7vL._SY445_SX342_.jpg",
        print_length: "288 pages",
        language: "English",
        author_name: "Barry Strauss",
        price: "1200",
    },
    {
        id: 18,
        book_name: "Valmiki Ramayana In English",
        book_description: "Ramayan is one of the largest ancient epics in the world. It consists of nearly 24,000 verses that are divided into seven kandas (episodes). The epic, traditionally ascribed to the Maharishi Valmiki, narrates the life of Lord Ram, the legendary prince of Ayodhya city in the kingdom of Kosala.",
        book_url: "https://m.media-amazon.com/images/I/81raX2PUDiL._SY466_.jpg",
        print_length: "387 pages",
        language: "English",
